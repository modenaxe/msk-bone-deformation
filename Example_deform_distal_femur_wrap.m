...
deformed_model_suffix = ['_WrapTors',upper(bone_short(1)),bone_short(2:end),'_',torsion_doc_string];
...
osimModel = applyTorsionToWrappingSurface(osimModel, bone_to_deform, torsionAxis, torsion_angle_func_rad);
